...
import { ArchiveTicketButton } from "@/components/projects/archive-ticket-button";
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <aside className="grid content-start gap-5 lg:sticky lg:top-6 lg:self-start">
            <section className="rounded-2xl border border-stone-200 bg-white p-5 shadow-sm" aria-label="Ticket details">
              ...
              {canWork && ticket.status === "completed" && <ArchiveTicketButton projectId={projectId} ticketId={ticketId} ticketTitle={ticket.title} />}
            </section>
